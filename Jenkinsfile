            ...
            steps {
                ...
                script {
                    env.DEV_TEST_STATUS = sh(
                        script: 'npx playwright test --grep "@sanity" --config=playwright.config.dev.ts',
                        returnStatus: true
                    ) == 0 ? 'success' : 'failure'
                }
            ...
            steps {
                ...
                script {
                    env.QA_TEST_STATUS = sh(
                        script: 'npx playwright test --grep "@sanity" --config=playwright.config.qa.ts',
                        returnStatus: true
                    ) == 0 ? 'success' : 'failure'
                }
            ...
            steps {
                ...
                script {
                    env.STAGE_TEST_STATUS = sh(
                        script: 'npx playwright test --grep "@sanity" --config=playwright.config.stage.ts',
                        returnStatus: true
                    ) == 0 ? 'success' : 'failure'
                }
            ...
            steps {
                ...
                script {
                    env.PROD_TEST_STATUS = sh(
                        script: 'npx playwright test --grep "@sanity" --config=playwright.config.prod.ts',
                        returnStatus: true
                    ) == 0 ? 'success' : 'failure'
                }
